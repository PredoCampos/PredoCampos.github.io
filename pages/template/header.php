<header class="header">
    <nav id="navigation">
        <div class="wrapper">
            <a class="logo close" href="home.html"> Predo Campos </a>
            <div class="menu">
                <ul>
                    <li>
                        <a id="aboutNav" class="close" href="about.html">Sobre mim</a>
                    </li>
                    <li>
                        <a id="projectsNav" class="close" href="projects.html">Projetos</a>
                    </li>
                    <li>
                        <a id="knowledgeNav" class="close" href="portfolio.html">Conhecimentos</a>
                    </li>
                    <li>
                        <a id="contactNav" class="close" href="contact.html">Fale comigo</a>
                    </li>
                </ul>
                <ul class="social-links">
                    <li>
                        <a href="https://instagram.com/lucyanovidio" title="Instagram" target="_blank">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17 1.99997H7C4.23858 1.99997 2 4.23855 2 6.99997V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V6.99997C22 4.23855 19.7614 1.99997 17 1.99997Z" stroke="#FFFAF1" stroke-width="2"
                    ...
                    <li>
                        <a href="https://github.com/lucyanovidio" title="Github" target="_blank">
                    ...
                    <li>
                        <a href="https://linkedin.com/in/lucyanovidio" title="LinkedIn" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                <path fill="none" d="M0 0h24v24H0z"/>
                    ...
                    <li>
                        <a href="https://twitter.com/lucyanovidio" title="Twitter" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                <path fill="none" d="M0 0h24v24H0z"/>
